...
( function() {
	...
	// The onlick function assigned to the 'Browse ServerModel' button. Opens the
...
/**
 * The location of an external file manager that should be launched when the **Browse ServerModel**
 * button is pressed. If configured, the **Browse ServerModel** button will appear in the
...
/**
 * The location of an external file browser that should be launched when the **Browse ServerModel**
