    ...
    <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'mobile'         , name: 'mobile'        ,  "width": "100px"},
                {data: 'amount'         , name: 'amount'        ,  "width": "150px"},
                {data: 'reason'         , name: 'reason'        ,  "width": "150px"},
                {data: 'hesabtitle'     , name: 'hesabtitle'    ,  "width": "100px"},
                {data: 'code'           , name: 'code'          ,  "width": "200px"},
                {data: 'hamahangname'   , name: 'hamahangname'  ,  "width": "180px"},
                {data: 'mobile2'        , name: 'mobile2'       ,  "width": "100px"},
                {
                    data: 'action',
                    name: 'action',
                    orderable: true,
