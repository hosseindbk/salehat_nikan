                ...
                <div class="row row-sm">
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                <div>
                                    <h6 class="main-content-label text-center mb-5">ثبت اطلاعات کاربر جدید</h6>
                                </div>
                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="melicode" data-required="1" placeholder="نام و نام خانوادگی را وارد کنید" class="form-control" />
                                            </div>
                                            <div class="form-group">
